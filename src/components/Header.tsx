...
export function Header({ activeTab }: { activeTab: TabName }) {
  return (
      ...
      <div className="flex items-center gap-6">
        <div className="relative hidden md:block group">
          <input 
            ...
            className="bg-slate-100 text-sm border-none rounded-full px-4 py-1.5 w-64 focus:ring-2 focus:ring-indigo-500 outline-none transition-all placeholder:text-slate-400 text-slate-700"
          />
        </div>
      </div>
    </header>
